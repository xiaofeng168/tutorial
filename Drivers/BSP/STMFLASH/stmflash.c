...
void stmflash_write(uint32_t waddr, uint32_t *pbuf, uint32_t length)
{
    ...
    while (addrx < endaddr)         /* 扫清一切障碍.(对非FFFFFFFF的地方,先擦除) */
    {
        ...
        {   
            ...
            flash_erase_init_handle.TypeErase = FLASH_TYPEERASE_SECTORS;    /* 擦除类型，扇区擦除 */
            ...
            flash_erase_init_handle.VoltageRange = FLASH_VOLTAGE_RANGE_3;   /* 电压范围，VCC=2.7~3.6V之间 */
    ...
    hal_status = FLASH_WaitForLastOperation(FLASH_WAITETIME, FLASH_BANK_1); /* 等待上次操作完成 */
