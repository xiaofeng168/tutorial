...
static void basic_init(void)
{
    ...
    lv_style_set_pad_top(&style_pad, LV_STATE_DEFAULT, LV_VER_RES / 30);   /* ∂•≤ø…Ë÷√ÃÓ≥‰(pad) */
    ...
    lv_style_set_radius(&style_circle, LV_STATE_DEFAULT, LV_RADIUS_CIRCLE); /* ∞Îæ∂ */

    lv_style_init(&style_bg);
    lv_style_set_bg_opa(&style_bg, LV_STATE_DEFAULT, LV_OPA_COVER);         /* ±≥æ∞ */
    lv_style_set_bg_color(&style_bg, LV_STATE_DEFAULT, LV_DEMO_PRINTER_LIGHT);
    lv_style_set_text_font(&style_bg, LV_STATE_DEFAULT, theme.font_normal); /* Œƒ±æ◊÷ÃÂ */
    ...
    lv_style_set_border_width(&style_box_border, LV_STATE_DEFAULT, 2);          /* ±ﬂøÚ */
    ...
    lv_style_init(&style_label_white);/* ±Í«© */
